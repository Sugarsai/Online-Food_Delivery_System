...
*/ -->
                ...
                $GroceriesManager = new GroceryManager();


                $groceries = $GroceriesManager->getAllGroceries();
                if (isset($_GET['delete_grocery'])) {
                    $groceryID = $_GET['delete_grocery'];
                    $GroceriesManager->deleteRelatedMenu($groceryID);
                    $GroceriesManager->deleteGrocery($groceryID);
                }
                                        ...
                                        <div class="col-lg-12">
                                            <div class="card card-outline-primary">
                                                <div class="card-header">
                                                    <h4 class="m-b-0 text-white">All Groceries</h4>
                                                </div>
...
*/ -->
                                                            ...
                                                            <?php
                                                            $GroceryID = $GroceriesManager->getGroceryId();
                                                            if (empty($groceries)) {
                                                                echo '<tr><td colspan="11"><center>No Groceries</center></td></tr>';
                                                            } else {
                                                        ...
                                                        <td>' . $grocery['phone'] . '</td>
                                                        <td>' . $grocery['url'] . '</td>
                                                        <td>' . $grocery['openHour'] . '</td>
                                                        <td>' . $grocery['closeHour'] . '</td>
                                                        <td>' . $grocery['workingDays'] . '</td>
                                                        <td>' . $grocery['address'] . '</td>
                                                        <td><img src="Grocery_img/' . $grocery['image'] . '" class="img-responsive radius" style="min-width:150px;min-height:100px;"/></td>
                                                        <td>' . $grocery['date'] . '</td>
                                                        <td>
                                                            ';
                                                                    echo '<button class="btn btn-danger btn-xs m-b-10" onclick="confirmDelete(' . $grocery['rs_id'] . ');">Delete</button>
                                                            <a href="update_grocery.php?grocery_upd=' . $grocery['rs_id'] . '" class="btn btn-info btn-xs m-b-10 m-l-5"><i class="fa fa-edit"></i> Edit</a>';
                                                                }
                                                            }
                                                            ?>

                                                            <script>
                                                                function confirmDelete(GroceryID) {
                                                                    if (confirm('Are you sure you want to delete this grocery ?')) {
                                                                        window.location.href = 'all_groceries.php?delete_grocery=' + GroceryID;
                                                                    }
                                                                }
                                                            </script>
