...
*/ -->
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $store = "Grocery_img/" . basename($fnew);
                    ...
                    $result = $grocery->addGrocery($name, $email, $phone, $url, $openHour, $closeHour, $workingDays, $fnew, $address);

                    if ($result === true) {
                        move_uploaded_file($temp, $store);
                        $success = '<div class="alert alert-success alert-dismissible fade show">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            New Grocery Added Successfully.
        </div>';
                    } else {
                        $error = '<div class="alert alert-danger alert-dismissible fade show">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
*/ -->
                                        ...
                                        <li>
                                            <a class="has-arrow" href="#" aria-expanded="false">
                                                ...
                                                <span class="hide-menu">Groceries</span>
                                            </a>
                                            <ul aria-expanded="false" class="collapse">
                                                <li><a href="all_groceries.php">All Groceries</a></li> <!-- Updated link to all_groceries.php -->
                                                <li><a href="add_grocery.php">Add Grocery</a></li> <!-- Updated link to add_grocery.php -->
                                            </ul>
                                        </li>
                                ...
                                <div class="col-lg-12">
                                    <div class="card card-outline-primary">
                                        <div class="card-header">
                                            <h4 class="m-b-0 text-white">Add Grocery</h4>
                                        </div>
                                        <div class="card-body">
                                                    ...
                                                    <div class="row p-t-20">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="control-label">Grocery Name</label>
                                                                <input type="text" name="groc_name" class="form-control">
                                                            </div>
                                                        </div>
...
*/ -->
                                                    ...
                                                    <h3 class="box-title m-t-40">Grocery Address</h3>
                                                    <hr>
                                                    <div class="row">
                                                        <div class="col-md-12 ">
                                                            <div class="form-group">
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <a href="add_grocery.php" class="btn btn-inverse">Cancel</a>
                                        </div>
                                        </form>
                                    </div>
                                </div>
