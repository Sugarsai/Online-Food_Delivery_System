...
$result = $Order->getUserOrders($user_id);	
...
?>
        ...
        <a href="javascript:void(0);" onclick="confirmDelete(<?php echo $row['o_id']; ?>);" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10">
            <i class="fa fa-trash-o" style="font-size:16px"></i> </a>  
            <script>
            function confirmDelete(orderId) {
             if (confirm('Are you sure you want to cancel your order?')) {
                window.location.href = 'your_orders.php?delete_order=' + orderId;
            }
        }
    </script>
        </td>
